...
{
    public class HistoryHandler : GibddHandler
    {
        ...
        public HistoryResult Get(RequestObject requestObject, string captchaWord, string sessionId)
        {
            var auto = requestObject as Auto;

            //var historyCacheItem = cacheItems.First(x => x.ActionType == ActionType.History);
            return _gibddManager.GetHistory(auto.Vin, captchaWord, sessionId);
